...
function new_model(; in_channels = 65, res = (256, 256))
    ...
    # backbone = Metalhead.backbone(DenseNet(121; inchannels = middle_channels))
    backbone = Metalhead.backbone(Metalhead.ResNet(18; inchannels = middle_channels))
    unet = Chain(Metalhead.unet(backbone, (res..., middle_channels, 1), 1).layers...)
